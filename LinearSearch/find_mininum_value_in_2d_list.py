...
def min_val_in_2d_list(element_list):
    '''
    Function return the minimum value in the 2d list if the list is not empty.
...
result, index = min_val_in_2d_list(element_list)

if result:
    print(f"Minimum element in the 2d list is {result} found at index {index}")
else:
...
# call the linear search function to search the element
result, index = min_val_in_2d_list(word)

if result:
    print(f"Minimum char in the 2d string is {result} found at index {index}")
else:
